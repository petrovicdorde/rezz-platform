...
export function RegisterForm({
  ...
  return (
    ...
    >
      ...
      <div className="mt-1 text-center text-sm text-[rgba(20,11,0,0.55)]">
        {t('auth.already_have_account')}{' '}
        <button
          type="button"
          onClick={onLogin}
          className="cursor-pointer font-semibold text-secondary-400 transition-colors hover:text-secondary-500"
        >
          {t('auth.login_link')}
        </button>
      </div>
