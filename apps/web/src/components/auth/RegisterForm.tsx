...
export function RegisterForm({ onSuccess, onLogin }: RegisterFormProps): React.JSX.Element {
  ...
  return (
    ...
    >
        ...
        <div>
          ...
          <Input
            ...
            {...register('firstName', {
              ...
              minLength: {
                value: 2,
                message: t('auth.first_name_min_length'),
              },
            })}
          />
          {errors.firstName && (
        ...
        <div>
          ...
          <Input
            ...
            {...register('lastName', {
              ...
              minLength: {
                value: 2,
                message: t('auth.last_name_min_length'),
              },
            })}
          />
          {errors.lastName && (
        ...
        <div className="relative">
          <Input
            ...
            {...register('confirmPassword', {
              required: t('auth.password_required'),
              validate: (value) =>
                value === getValues('password') || t('auth.passwords_not_match'),
            })}
          />
          <button
            type="button"
      ...
      >
        {registerMutation.isPending ? t('common.loading') : t('auth.register_button')}
      </Button>
