...
export const VENUE_PLACEHOLDER_IMG =
...
export function VenueCard({
  ...
  return (
    <div
      onClick={onClick}
      className={cn(
        "group relative h-80 cursor-pointer overflow-hidden rounded-[22px] shadow-[0_1px_2px_rgba(20,11,0,0.06),0_4px_12px_rgba(20,11,0,0.07),0_12px_28px_rgba(20,11,0,0.07)] transition-all duration-400 ease-[cubic-bezier(0.2,0.8,0.2,1)]",
        isGuest &&
    ...
    >
      ...
      <div
        aria-hidden
        className={cn(
          "absolute inset-0 bg-cover bg-center transition-transform duration-600 ease-[cubic-bezier(0.2,0.8,0.2,1)]",
